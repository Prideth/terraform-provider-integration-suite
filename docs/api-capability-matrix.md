...
| Integration Content | Value Mapping (Designtime Artifact) | Design-time | Yes | OData V2 | Yes | Yes | Yes (new version) | Yes | via `DeployValueMappingDesigntimeArtifact` action | Resource (planned v0.1.x stretch) |
